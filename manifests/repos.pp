...
class kubernetes::repos (
  ...
  Boolean $manage_repo_docker     = $kubernetes::manage_repo_docker,
  Boolean $manage_repo_kubernetes = $kubernetes::manage_repo_kubernetes,
){
